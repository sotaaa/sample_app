# -*- encoding: utf-8 -*-
# stub: aws-sdk-shield 1.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2017-11-22"
  s.description = "Official AWS Ruby gem for AWS Shield. This gem is part of the AWS SDK for Ruby."
  s.email = ["trevrowe@amazon.com"]
  s.homepage = "http://github.com/aws/aws-sdk-ruby"
  s.licenses = ["Apache-2.0"]
  s.rubygems_version = "2.4.8"
  s.summary = "AWS SDK for Ruby - AWS Shield"
